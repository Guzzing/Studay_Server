...
public class AcademyCalendarService {
    ...
    private List<GeneratedLessonSchedule> generateAcademySchedules(AcademyCalendarCreateParam param) {
        return param.lessonScheduleParams()
            .stream()
    ...
    public AcademyCalendarLoadToUpdateResult loadTimeTemplateToUpdate(Long academyScheduleId) {
        AcademyScheduleLoadInfo distinctAcademyTimeTemplate = academyScheduleRepository.findDistinctAcademyTimeTemplate(academyScheduleId);

        return AcademyCalendarLoadToUpdateResult.of(distinctAcademyTimeTemplate);
    }
    ...
    public AcademyCalendarUpdateResults updateTimeTemplate(
        ...
        List<AcademyTimeTemplateDateInfo> academyTimeTemplates = academyTimeTemplateRepository.findAcademyTimeTemplateByDashboardId(
            ...
            academyCalendarUpdateParam.lessonScheduleParams().dayOfWeek());
