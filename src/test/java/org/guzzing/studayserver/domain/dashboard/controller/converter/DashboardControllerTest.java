        ...
        perform.andDo(print())
                ...
                .andDo(document("get-dashboard",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("academyInfo.shuttleAvailability").type(STRING).description("셔틀 운행 여부"),
                                ...
                                fieldWithPath("academyInfo.areaOfExpertise").type(STRING).description("강의 분야 구분"),
        ...
        perform.andDo(print())
                ...
                .andDo(document("get-dashboards",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("responses[].academyInfo.contact").type(STRING).description("학원 연락처"),
                                fieldWithPath("responses[].academyInfo.fullAddress").type(STRING).description("학원 주소"),
                                fieldWithPath("responses[].academyInfo.shuttleAvailability").type(STRING)
                                        .description("셔틀 운행 여부"),
                                fieldWithPath("responses[].academyInfo.expectedFee").type(NUMBER).description("예상 교육비"),
                                ...
                                fieldWithPath("responses[].lessonInfo.capacity").type(NUMBER).description("수업 정원"),
                                fieldWithPath("responses[].lessonInfo.duration").type(STRING).description("강의 기간"),
                                fieldWithPath("responses[].lessonInfo.totalFee").type(NUMBER).description("총 수강료"),
